...
const ProjectModal: React.FC<ModalProps> = ({ modal, closeModal, handlePreviousImage, handleNextImage }) => {
  ...
  return (
    <ProjectStyle.Modal onClick={closeModal}>
      <ProjectStyle.ModalContent onClick={(e) => e.stopPropagation()}>
        <ProjectStyle.ArrowButton className="left" onClick={handlePreviousImage}>
        ...
        </ProjectStyle.ArrowButton>
        <Image src={modal.image} alt="Imagem em destaque" width={1200} height={800} />
        <ProjectStyle.ArrowButton className="right" onClick={handleNextImage}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g
              id="SVGRepo_tracerCarrier"
