  ...
  return (
    <>
      ...
      <AboutContainer>
        <StudioDescription>
          <h2>
            O Studio Chifrezz é um estúdio de animação brasileiro liderado por
            mulheres. Fundado em 2021 no Rio de Janeiro, nossa missão é dar vida
            a histórias autorais que inspirem o público através de suas
            animações em diversos formatos, como Séries de TV e Curtas
            Metragens.
          </h2>
        </StudioDescription>
        <Us>
